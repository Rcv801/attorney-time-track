    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-slate-600">Line items, payment history, and live balance tracking.</p>
        </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <div>
              <p className="text-sm text-slate-600">Stored PDF</p>
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            ...
            <Card>
              <CardContent className="p-4">
                <p className="text-sm text-slate-600">Trust Applied</p>
                ...
                {invoice.lineItems.map((lineItem) => (
                  <TableRow key={lineItem.id}>
                    ...
                    <TableCell>
                      ...
                      {lineItem.matterName && (
                        <div className="text-xs text-slate-600">{lineItem.matterName}</div>
                      )}
                    </TableCell>
      ...
      <Dialog open={isSendDialogOpen} onOpenChange={setIsSendDialogOpen}>
        <DialogContent className="sm:max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-md border bg-slate-100/50 p-3 text-sm text-slate-600">
              {invoice.paymentLink
